...
class QulacsComputationAdapter
{
public:
    QulacsComputationAdapter() = default;
    QulacsComputationAdapter(const QuantumTask quantum_task) : 
        quantum_tasks{quantum_task}
    { }
    QulacsComputationAdapter(const std::vector<QuantumTask> quantum_tasks, const int& n_comm_qubits) : 
