...
import unittest
from test_qjob import TestQJob
from test_qpu import TestQPU, Test_qraise, Test_qdrop, Test_get_QPUs
from test_transpile import TestTranspErrors
...
if __name__ == "__main__":
    ...
    suite.addTests(loader.loadTestsFromTestCase(Test_get_QPUs)) #I run this test first to try to avoid encountering error w getQPUs reading dropped QPUs
