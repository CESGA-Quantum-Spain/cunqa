...
from cunqa.circuit import CunqaCircuit, _flatten, SUPPORTED_GATES_DISTRIBUTED, SUPPORTED_GATES_1Q
from cunqa.converters import qc_to_json
...
CunqaCircuit.update_other_instances = update_other_instances

CunqaCircuit.__add__   = __add__
CunqaCircuit.__radd__  = __radd__
CunqaCircuit.__iadd__  = __iadd__

CunqaCircuit.__or__  = __or__
CunqaCircuit.__ror__ = __ror__
CunqaCircuit.__ior__ = __ior__

CunqaCircuit.__len__
CunqaCircuit.param_info = param_info
CunqaCircuit.index = index
CunqaCircuit.__contains__ = __contains__
CunqaCircuit.__getitem__  = __getitem__
CunqaCircuit.__setitem__  = __setitem__

CunqaCircuit.vert_split = vert_split
CunqaCircuit.hor_split  = hor_split

CunqaCircuit.draw = draw