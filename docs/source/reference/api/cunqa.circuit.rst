...
communication directives, which are so vital in CUNQA as a DQC platform. This way, 
...
combine the gates of two circuits or, conversely, to create several circuits from a single one. 
To enable this capability, this module exists, defining the following functions.
